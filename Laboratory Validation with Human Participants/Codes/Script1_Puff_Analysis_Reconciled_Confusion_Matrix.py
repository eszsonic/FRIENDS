...
def main(participant_dir, out_xlsx_path):
    ...
    print(f'Pooled Precision={p_pool:.4f}  Recall={r_pool:.4f}  F1={f1_pool:.4f}')
    print('\nMean/Median/Mode:')
...
if __name__ == '__main__':
    # ---- UPDATE THIS PATH ----------------------------------------
    Participant_Dir = r'C:\FRIENDS_UB_LAB\FRIENDS Paper Lab Data, Code and Results\Participant Data'
    Out_Xlsx = r'C:\FRIENDS_UB_LAB\FRIENDS Paper Lab Data, Code and Results\Results\Reconciled_Detection_Metrics_Summary.xlsx'
    # --------------------------------------------------------------
    if len(sys.argv) >= 3:
